      ...
      <div className="app">
        ...
        <footer className="footer">
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: "20px", marginBottom: "16px" }}>
            ...
            <a href="https://www.youtube.com/@comunidadedorockbr" target="_blank" rel="noopener noreferrer" title="YouTube" style={{ color: "#999", fontSize: "24px", textDecoration: "none", transition: "color 0.3s" }} onMouseEnter={e => e.target.style.color = "#e91e63"} onMouseLeave={e => e.target.style.color = "#999"}>
