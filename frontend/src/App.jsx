      ...
      <div className="app">
        ...
        <footer className="footer">
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: "20px", marginBottom: "16px" }}>
            <a href="https://www.instagram.com/comunidadedorock" target="_blank" rel="noopener noreferrer" title="Instagram" style={{ color: "#999", fontSize: "24px", textDecoration: "none", transition: "color 0.3s" }} onMouseEnter={e => e.target.style.color = "#e91e63"} onMouseLeave={e => e.target.style.color = "#999"}>
            ...
            <a href="https://www.tiktok.com/@comunidadedorock" target="_blank" rel="noopener noreferrer" title="TikTok" style={{ color: "#999", fontSize: "24px", textDecoration: "none", transition: "color 0.3s" }} onMouseEnter={e => e.target.style.color = "#e91e63"} onMouseLeave={e => e.target.style.color = "#999"}>
            ...
            <a href="https://www.youtube.com/channel/UC0cR_q42mrQWp7UdLgS5irg" target="_blank" rel="noopener noreferrer" title="YouTube" style={{ color: "#999", fontSize: "24px", textDecoration: "none", transition: "color 0.3s" }} onMouseEnter={e => e.target.style.color = "#e91e63"} onMouseLeave={e => e.target.style.color = "#999"}>
